//Se crea el objeto con todas las funciones a utiliar
class EventsManager
  {
    constructor()
      {
        ...
        $.ajax(
          { //SE OBTIENEN LOS EVENTOS
            ...
            success: (data) =>
              {
                if (data.msg=="OK")
                  {// SE LLENA EL CALENDARIO (poblarCalendario)
    ...
    //Funcion para colocar en el calendario todos los eventos
        ...
        $('.calendario').fullCalendar(
          {
            ...
            timeFormat: 'H:mm',
            eventDrop: (event) =>
              { /*que seria el parametro event de donde sale?*/
            ...
            eventDragStop: (event,jsEvent) =>
             { /*de donde salen estos parametros? que son cada uno?*/
    ...
    //Funcion para anadir nuevos eventos
    anadirEvento()
      {
    ...
    //Funcion para actualizar eventos del calendario
...
//Funcion anonima autoejecutable que inicia todo el proceso
$(function()
  {
    initForm();
...
//Funcion para colocar en blanco los campos del formulario de registro de nuevos eventos
function initForm()
  {
